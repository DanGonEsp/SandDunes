...
print ("	SlipDiff         	= " .. tostring (boolSlipDiff))
...
A1= 1.673
k0 = 1.0 + A1 * (1-dp/d1)
Diff_factor = Diff_beta*k0*k0*Ws/(2*rho_a*9.81)
...
ss_value = math.atan(FricMu_2)*180/3.1415926
...
solver:add_inner_step_update(SlipDiff)
solver:add_inner_step_update(SlipVel)
