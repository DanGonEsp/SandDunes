...
To install the Daniel's version of the simulator, run the following commands in a folder where you want to have UG4:
	...
	9.	cd ../..
	10.	mkdir build; cd build																		## Creating the temporary build folder
	11.	cmake ../ug4 -DDIM=2 -DCPU="1;4" -DNavierStokes=ON    										## Initializing the directory and setting the build arguments
