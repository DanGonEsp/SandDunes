...
def WeakScalability(folder, step, factor):
    ...
    print("============================================================================================================================")
    print(f"{'Level':>7} {'PE':>6} {'DoFs':>12} {'DoFs/PE':>12} {'NTimeSteps':>14} {'Twall(s)':>14} {'CFLNorm(s)':>14} {'RawEff':>10} {'CFLEff':>10}")
    print("----------------------------------------------------------------------------------------------------------------------------")
    ...
    for case in cases:
        ...
        print(f"{case[0]:7d} {case[1]:6d} {dofs:>12} {dofs_per_pe:>12} {ntime_steps:>14} {case[3]:14.6f} {case[14]:14.6f} {case[13]:10.3f} {case[15]:10.3f}")
